...
var chartData = [{
    country: "Positive",
    value:Math.abs(${ChannelPositiveList.get(12)[1]})},
 {
    country: "Negative",
    value:Math.abs(${ChannelNegativeList.get(12)[1]})
  }];
...
/*     
   ...
   chart.addTitle("${ChannelList[12].getChannelName()}");
    chart.addTitle("Total No Of  News:${ChannelPositiveList.get(12)[1]-ChannelNegativeList.get(12)[1]}");
...
var chartData1 = [{
    country: "Positive",
    value:Math.abs(${ChannelPositiveList.get(13)[1]})},
 {
    country: "Negative",
    value:Math.abs(${ChannelNegativeList.get(13)[1]})
  }];
...
/*     
    ...
    chart1.addTitle("${ChannelList[13].getChannelName()}");
    chart1.addTitle("Total No Of  News:${ChannelPositiveList.get(13)[1]-ChannelNegativeList.get(13)[1]}"); 
...
var chartData2 = [{
    country: "Positive",
    value:Math.abs(${ChannelPositiveList.get(14)[1]})},
 {
    country: "Negative",
    value:Math.abs(${ChannelNegativeList.get(14)[1]})
  }];
...
/*     
    ...
    chart2.addTitle("${ChannelList[14].getChannelName()}");
    chart2.addTitle("Total No Of  News:${ChannelPositiveList.get(14)[1]-ChannelNegativeList.get(14)[1]}"); 
...
var chartData3 = [{
country: "Positive",
value:Math.abs(${ChannelPositiveList.get(15)[1]})},
{
country: "Negative",
value:Math.abs(${ChannelNegativeList.get(15)[1]})
}];
...
chart3.addTitle("${ChannelList[15].getChannelName()}");
 chart3.addTitle("Total No Of  News:${ChannelPositiveList.get(15)[1]-ChannelNegativeList.get(15)[1]}");  
...
<a href="PieChartReport.do?param=AllChannelNegativePositive3&clientId=${clientId}&todate=${todate}&fromdate=${fromdate}">Previous</a>
</tr>
	</table>
	</form:form>
</body>
