...
<body>
	<form:form method="POST" modelAttribute="Client" action="clientAdd.do"
		autocomplete="off">
		<table>
			<tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1"
			...
			<tr>
				...
				<td><form:input path="clientName" maxlength="20" /></td>
			</tr>
			<tr>
				<td></td>
				<td><form:errors path="clientName" cssClass="error"></form:errors></td>
			</tr>
			<tr>
			...
			<table border="0" cellspacing="1" cellpadding="1" class="mid_tbl"
				...
				<c:forEach items="${clientContent}" var="content">
					<tr>
						...
						<td><a href="clientContent/${content.clientId}.do"
