...
var chartData = [{
    country: "Positive",
    value:Math.abs(${ChannelPositiveList.get(4)[1]})},
 {
    country: "Negative",
    value:Math.abs(${ChannelNegativeList.get(4)[1]})
  }];
...
/*     
    ...
    chart.addTitle("${ChannelList[4].getChannelName()}");
    chart.addTitle("Total No Of  News:${ChannelPositiveList.get(4)[1]-ChannelNegativeList.get(4)[1]}");
...
var chartData1 = [{
    country: "Positive",
    value:Math.abs(${ChannelPositiveList.get(5)[1]})},
 {
    country: "Negative",
    value:Math.abs(${ChannelNegativeList.get(5)[1]})
  }];
...
/*     
    ...
    chart1.addTitle("${ChannelList[5].getChannelName()}");
    chart1.addTitle("Total No Of  News:${ChannelPositiveList.get(5)[1]-ChannelNegativeList.get(5)[1]}"); 
...
var chartData2 = [{
    country: "Positive",
    value:Math.abs(${ChannelPositiveList.get(6)[1]})},
 {
    country: "Negative",
    value:Math.abs(${ChannelNegativeList.get(6)[1]})
  }];
...
/*     
    ...
    chart2.addTitle("${ChannelList[6].getChannelName()}");
    chart2.addTitle("Total No Of  News:${ChannelPositiveList.get(6)[1]-ChannelNegativeList.get(6)[1]}"); 
...
var chartData3 = [{
country: "Positive",
value:Math.abs(${ChannelPositiveList.get(7)[1]})},
{
country: "Negative",
value:Math.abs(${ChannelNegativeList.get(7)[1]})
}];
...
chart3.addTitle("${ChannelList[7].getChannelName()}");
 chart3.addTitle("Total No Of  News:${ChannelPositiveList.get(7)[1]-ChannelNegativeList.get(7)[1]}");  
...
<tr>
 ...
 <table><tr><td>
<a href="PieChartReport.do?param=AllChannelNegativePositive2&clientId=${clientId}&todate=${todate}&fromdate=${fromdate}">Previous</a>&nbsp;&nbsp;&nbsp;&nbsp;
<c:if test="${fn:length(ChannelList) >4 }">
<a href="PieChartReport.do?param=AllChannelNegativePositive3&clientId=${clientId}&todate=${todate}&fromdate=${fromdate}">Next</a>
</c:if> 
</td></tr><tr><td>   
<input class="noContentPrint" type="button" value="Print" onclick="window.print()" />
</td></tr></table>	
	</form:form>
</body>
</html>
