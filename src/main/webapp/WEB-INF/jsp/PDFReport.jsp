...
<script type="text/javascript" src="js/jsp-js/pdfReport.js"></script>
...
<body>
	<form:form method="POST" action="EMTorPDFReport.do"
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1"
			...
			<tr>
				...
				<td>
					...
					id="datepicker" readonly="readonly" /> <form:hidden path="fromDate"
						id="dateField" />
				</td>
				<td><b>To</b></td>
				<td>
					<%-- <form:input path="toDate" /> --%> <input type="text"
					id="datepicker1" readonly="readonly" /> <form:hidden path="toDate"
						id="dateField1" />
				</td>
			</tr>
			<tr>
